...
export function CosPhiGraphComponent() {             
    ...
    function initGraph(chartId, graphOptions){
        ...
        marks.forEach(mark => {
            ...
            dataset.add({
                ...
                y: formats[graphOptions.yFormat](mark.value)
            });
        });
        ...
        function addDataPoints(yValues){
            ...
            yValues.forEach(yValue =>{
                dataset.add({
                    group: yValue.group,
                    x: now,
                    y: formats[graphOptions.yFormat](yValue.value),
                    label: {
                    content: yValue.value.toFixed(3),
                    xOffset: 20,
                    yOffset: 20
                    }
                });
